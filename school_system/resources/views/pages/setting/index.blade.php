                    ...
                    <div class="row">
                        <div class="col-md-7 border-right-2 border-right-blue-400">
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label font-weight-semibold">School's Name : <span
                            ...
                            <div class="form-group row">
                                <label for="current_session" class="col-lg-3 col-form-label font-weight-semibold">Session : <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label font-weight-semibold">School's title : </label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label font-weight-semibold">School's Address<span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label font-weight-semibold">First_Term's End</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label font-weight-semibold">Second_Term's End</label>
                                <div class="col-lg-9">
